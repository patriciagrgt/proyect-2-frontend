  ...
  return (
    <div className="bg-green-50 min-h-screen p-8">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-4xl font-bold text-green-800 mb-6 mt-6">Sobre Nosotros</h1>
        <p className="text-lg text-gray-700 mb-6">
          En <span className="font-semibold text-green-600">NaturalHub</span>, nos dedicamos a ofrecerte una selección cuidadosamente curada de los mejores productos naturales y ecológicos de marcas comprometidas con el bienestar y la sostenibilidad. Creemos en la importancia de cuidar tu cuerpo y el planeta, por eso elegimos solo productos que respeten ambos.
        </p>
        <p className="text-lg text-gray-700 mb-6">
        ...
        <p className="text-lg text-gray-700 mb-6">
          En <span className="font-semibold text-green-600">NaturalHub</span>, no solo te ofrecemos productos, te ofrecemos una forma de vida más consciente y respetuosa con el medio ambiente. Únete a nuestra comunidad y descubre cómo pequeños cambios pueden hacer una gran diferencia.
        </p>
        ...
        <h2 className="text-2xl font-bold text-green-800 mt-16 mb-8">Nuestro Compromiso</h2>
        ...
        <h2 className="text-2xl font-bold text-green-800 mt-16 mb-8">Nuestra Misión</h2>
        <p className="text-lg text-gray-700 mb-6">
          En <span className="font-semibold text-green-600">NaturalHub</span>, nuestra misión es facilitarte el acceso a productos naturales y ecológicos de alta calidad, ayudándote a tomar decisiones más conscientes y saludables. Queremos ser tu aliado en el camino hacia un estilo de vida más sostenible.
        </p>
